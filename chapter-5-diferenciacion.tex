...
\begin{align*}
    ...
    + \underbrace{f'(x_0)\, h \cdot o(h)}_{o(h)}
...
\begin{example}
    ...
    Quedó como ejercicio en una de las secciones anteriores calcular $\tan'(x)$, y la respuesta es
    \[
    \tan'(x)=\frac1{\cos^2x}.
    \]
...
\begin{example}
    ...
    \]
    Para encontrar este máximo, observamos que podemos despejar $a=\frac p2-b$ con lo que el área a maximizar resulta $\big(\frac p2-b\big)b$. Podemos llamar $x=b$ y observamos que los posibles valores de $x$ son $0<x<p/2$. Luego, queremos encontrar el máximo de la función
    \[
    f:(0,p/2)\to \R,\qquad
